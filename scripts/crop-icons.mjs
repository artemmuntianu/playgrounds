...
const MAP = {
  ...
  round_tree_bench:   [3, 1095, 493],
  table_game_station: [3, 824, 658],
  community_toy_box:  [3, 964, 658],
  pet_water_fountain: [3, 1099, 658],

  // PACK 4
  wheelchair_swing:   [4, 58, 203],
  ...
  solar_sensor_post:  [4, 853, 378],
  musical_pipes:      [4, 853, 516],
  sand_drawing_board: [4, 853, 660],
  charging_station:   [4, 1090, 218],
  ...
  sand_water_table:   [5, 579, 632],
  amphitheater_stage: [5, 853, 219],
  lookout_tower:      [5, 853, 378],
  castle_rampart:     [5, 853, 516],
  submarine_play:     [5, 853, 660],
  compost_bin:        [5, 1090, 219],
  insect_hotel:       [5, 1090, 374],
  greenhouse_dome:    [5, 1090, 527],
  eco_signage:        [5, 1090, 673],
  ...
  hand_sanitizer:     [6, 854, 218],
  recycling_bin:      [6, 854, 378],
  surveillance_camera:[6, 853, 523],
  first_aid_station:  [6, 854, 665],
  parent_seating:     [6, 1091, 219],
